...
Search through [old issues](https://github.com/protrex-dev/react-firebase/issues) before submitting a new
issue as your question may have already been answered.

If your issue appears to be a bug, and hasn't been reported,
[open a new issue](https://github.com/protrex-dev/react-firebase/issues/new). Please use the provided bug
...
requested the feature in the [existing issues](https://github.com/protrex-dev/react-firebase/issues), go
ahead and [open a new issue](https://github.com/protrex-dev/react-firebase/issues/new). Feel free to remove
...
Sweet, we'd love to accept your contribution! [Open a new pull request](https://github.com/protrex-dev/react-firebase/pull/new/master)
...
If you'd like to contribute to ReactFirebase, you'll need to do the following to get your environment
set up.
...
1. `cd` into the _react-firebase_ directory. Run `yarn` and `yarn watch`.
1. In a new terminal, `cd` into the _react-firebase/sample_ directory. run `yarn` and
   `yarn start`.
1. Head over to https://localhost:3000 to see the running sample! If you edit
   the react-firebase source, the sample will reload.

### Testing

1. `cd` into the _react-firebase/react-firebase_ directory
1. run `yarn test`
...
The output files - `react-firebase.js` and `react-firebase.min.js` - are written to the `/dist/` directory.
